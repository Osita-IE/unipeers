      ...
      >
        <View style={introStyles.layer}>
          ...
          <View style={introStyles.body}>
            <Text style={introStyles.bodyText}>The school app for socialising. Connect
              with friends, create your own event, 
              and find other amazing events from students.
            </Text>
          </View>

          <View>
            <TouchableOpacity style={introStyles.btn}>
                <Text style={introStyles.btnText}>Get 
                Started</Text>
            </TouchableOpacity>
          </View>
