    ...
    <View style={aboutStyles.wrapper}>
      ...
      <View style={aboutStyles.body}>
        ...
        <View style={aboutStyles.aboutBlock}>
          <Text style={aboutStyles.aboutText}>Unipeers is a social media app made for tertiary
             institution students to connect with friends and classmates.</Text>
          ...
          <Text style={aboutStyles.aboutText}>It goes further! You can find events in other schools right from your own campus</Text>
        </View>
        ...
        <View style={aboutStyles.featuresBlock}>
            ...
            <View style={aboutStyles.featureBlock}>
              <Text style={aboutStyles.featureTitle}>Post</Text>
